...
5. [maptools](https://cran.r-project.org/web/packages/tmap/vignettes/tmap-nutshell.html) - Maptools has a number of functions to explore the spatial relations in data.